...
// 汎用モーダル: モバイルはボトムシート、デスクトップは中央ダイアログ。
// トリガーボタン・backdrop・panel を同一コントローラ要素内に置いて使う。
// (record-modal を収支フォーム専用から切り出した汎用版)
export default class extends Controller {
  ...
  disconnect() {
    ...
    if (this._isOpen) document.body.style.overflow = ""
  }
